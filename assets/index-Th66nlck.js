...
.logos {
  ...
  `,t.prepend(e);function n(){e.remove(),t.remove()}return{el:t,destroy:n}}function T(t){t.innerHTML="";const e=k();t.appendChild(e);const n=e.querySelector("#slot-start");if(n){const s=C({text:"Empezar",id:"btn-start"},()=>{location.hash="#/start"});n.replaceWith(s.el)}const o=e.querySelector("#slot-logos");if(o){const s=_();o.replaceWith(s.el)}}function Z(){const t=document.createElement("style");t.textContent=`
.main {
  display: flex;
  justify-content: center;
}
...
.main__title {
  ...
  margin-top: 120px;
    ...
    `,e.prepend(t),e}function q(t){t.innerHTML="";const e=Z();t.appendChild(e);const n=e.querySelector("#slot-start");if(n){const s=C({text:"¡Jugar!",id:"btn-start"},()=>{location.hash="#/play"});n.replaceWith(s.el)}const o=e.querySelector("#slot-logos");if(o){const s=_();o.replaceWith(s.el)}}function I(){const t=document.createElement("style");t.textContent=`
.main {
  display: flex;
  justify-content: center;
}
...
.logo {
  ...
  display: block;
    ...
    `,e.prepend(t),e}function j(){let t=null;const e=document.createElement("div");e.className="move logos";const n=document.createElement("style");n.textContent=`
.logos {
    margin-top: auto;
    display: flex;
    align-items: flex-end;
...
.main__container {
 ...
 <main class="main">
    ...
    `,e.prepend(t),e}const D="/gh-pages-PPT/assets/starGanaste-oUVkQ_YI.png",z="/gh-pages-PPT/assets/starPerdiste-CBVTymL7.png",U={win:D,lose:z};function G(t){const e=new Image;e.src=U[t],e.alt=t==="win"?"Ganaste":"Perdiste",e.className="img-star";const n=document.createElement("style");n.textContent=`
    .img-star{
display:block;
      width:160px;
      height:auto;
